...
function Navbar(props) {
  ...
  return (
    <div className='flex justify-between items-center sm:w-11/12 sm:max-w-[1160px] w-full py-4 px-2 sm:px-0 mx-auto relative'>
        ...
        <div className={`fixed h-full w-screen sm:hidden backdrop-blur-sm top-0 right-0 translate-x-full  transition-all duration-700 z-50 ${isMobileMenuOpen && "-translate-x-0"}`}>
